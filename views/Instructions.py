...
with col1a:
    st.image('./assets/instruction_example1.png', caption='Correct ✅')
with col1b:
    st.image('./assets/instruction_example2.png', caption='Correct ✅')
with col1c:
    st.image('./assets/instruction_example3.png', caption='Wrong ❌')
...
with col1a:
    st.image('./assets/column_select_example1.png', caption="Example-1")
    st.markdown("""• Column no. containing x-values = 2  
    • Column no. containing y-values = 3  
    • Column no. containing elevations = 4""")

with col1b:
    st.image('./assets/column_select_example2.png', caption='Example-2')
...
with st.expander('### **Selecting Visualization Engine**'):
    ...
    st.image('./assets/visualization_engine_example.png', caption='Reference Image')
...
- :grey-background[**Elevation Labels**]: Toggle the display of elevation labels on the contours.""")
    st.image('./assets/map_setting_example.png', caption='Reference Image')
...
- :grey-background[**Aspect Ratio**]: Define the aspect ratio for your plot, e.g., "equal" ensures that one unit on the x-axis is equal to one unit on the y-axis.""")
    st.image('./assets/plot_setting_example.png', caption='Reference Image')
...
- :grey-background[**Grids Color**]: Choose the color of the grid lines.""")
    st.image('./assets/grid_setting_example.png', caption='Reference Image')
